...
can_decoder_c346_hs.pde: c346_hs_can.hex generateCode.py
	./generateCode.py c346_hs_can.hex -p 7 10 > can_decoder_c346_hs.pde

can_decoder_c346_ms.pde: c346_ms_can.hex generateCode.py
	./generateCode.py c346_ms_can.hex > can_decoder_c346_ms.pde

can_decoder_c346_info.pde: c346_info_can.hex generateCode.py
	./generateCode.py c346_info_can.hex -p 30 > can_decoder_c346_info.pde

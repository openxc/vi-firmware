 ...
 * 				support for I2C firmware library on LPC11Uxx
 * @version	:
 * @date	:
 * @author	:
 **************************************************************************
...
#ifndef LPC11Uxx_I2C_H
#define LPC11Uxx_I2C_H
...
Status I2C_MasterTransferData(LPC_I2C_Type *i2c, \
		I2C_M_SETUP_Type *TransferCfg, I2C_TRANSFER_OPT_Type Opt);
Status I2C_SlaveTransferData(LPC_I2C_Type *i2c, \

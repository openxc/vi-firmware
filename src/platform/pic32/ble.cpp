...
bool openxc::interface::ble::initialize(BleDevice* device)
{
	...
	sprintf(device_adv_name,"OPENXC-VI-%02X%02X%02X%02X",device->blesettings.bdaddr[2],device->blesettings.bdaddr[3],
								device->blesettings.bdaddr[4],device->blesettings.bdaddr[5]);

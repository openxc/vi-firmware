...
START_TEST (test_send_numerical)
{
    ...
    ck_assert_str_eq("test", decodedMessage.numerical_message.name);
    ck_assert_int_eq(42, decodedMessage.numerical_message.value);
}
END_TEST
...
START_TEST (test_preserve_float_precision)
{
    ...
    ck_assert_int_eq(openxc_VehicleMessage_Type_NUM, decodedMessage.type);
    ck_assert_str_eq("test", decodedMessage.numerical_message.name);
    ck_assert_int_eq(42.5, decodedMessage.numerical_message.value);
}
END_TEST
...
START_TEST (test_translate_float)
{
    ...
    openxc_VehicleMessage decodedMessage = decodeProtobufMessage(&PIPELINE);
    ck_assert_int_eq(openxc_VehicleMessage_Type_NUM, decodedMessage.type);
    ck_assert_str_eq("torque_at_transmission", decodedMessage.numerical_message.name);
    ck_assert_int_eq(42, decodedMessage.numerical_message.value);
}
END_TEST
